...
plt.yscale('log')
plt.legend(loc=1)
plt.savefig('jets_'+jet_type+'_eta_jrway_'+str(num_particles)+'p_beta0p00001_fulldata_earlystopping_latentdim'+str(latent_dim)+'_'+str(num_epochs)+'epochs.png')
plt.clf()
...
plt.yscale('log')
plt.legend(loc=1) 
plt.savefig('jets_'+jet_type+'_phi_jrway_'+str(num_particles)+'p_beta0p00001_fulldata_earlystopping_latentdim'+str(latent_dim)+'_'+str(num_epochs)+'epochs.png')
plt.clf()
...
plt.yscale('log')
plt.legend(loc=1) 
plt.savefig('jets_'+jet_type+'_pt_jrway_'+str(num_particles)+'p_beta0p00001_fulldata_earlystopping_latentdim'+str(latent_dim)+'_'+str(num_epochs)+'epochs.png')
plt.clf()
...
plt.legend()
plt.savefig('loss_jets_'+jet_type+'_jrway_'+str(num_particles)+'p_beta0p001_fulldata_earlystopping_latentdim'+str(latent_dim)+'_'+str(num_epochs)+'epochs.png')

# Save the model
torch.save(model.state_dict(), 'model_jets_'+jet_type+'_jrway_'+str(num_particles)+'p_beta0p001_fulldata_earlystopping_latentdim'+str(latent_dim)+'_'+str(num_epochs)+'epochs.pt')
