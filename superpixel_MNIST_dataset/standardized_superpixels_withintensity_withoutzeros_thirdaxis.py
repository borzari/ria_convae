...
for beta in beta_seq:
    ...
    def compute_loss(model, x):
        ...
        oei = torch.min(dist, dim = 2) # Gets the value of the distance between the closest input pixels to all the output pixels of the images in a batch (all features of the pixels)
    ...
    su_ta_teinpx = torch.Tensor().cuda()
    su_ta_teoutx = torch.Tensor().cuda()
    su_ta_gaussx = torch.Tensor().cuda()
    su_ta_teinpy = torch.Tensor().cuda()
    su_ta_teouty = torch.Tensor().cuda()
    su_ta_gaussy = torch.Tensor().cuda()
    su_ta_teinpi = torch.Tensor().cuda()
    su_ta_teouti = torch.Tensor().cuda()
    su_ta_gaussi = torch.Tensor().cuda()    
    ...
    plt.legend()
    plt.savefig('su_ta_loss_std_kl'+str(int(100*beta))+'_hardtanh.jpg')
    
    # Save the model
    torch.save(model.state_dict(), 'su_ta_model_std_kl'+str(int(100*beta))+'_hardtanh.pt')
    ...
    torch.save(su_ta_teinpx.cpu().detach(), 'su_ta_std_teinpx_kl'+str(int(100*beta))+'_hardtanh.pt') # Saving the tensors to plot histograms
    torch.save(su_ta_teoutx.cpu().detach(), 'su_ta_std_teoutx_kl'+str(int(100*beta))+'_hardtanh.pt') # Saving the tensors to plot histograms
    torch.save(su_ta_gaussx.cpu().detach(), 'su_ta_std_gaussx_kl'+str(int(100*beta))+'_hardtanh.pt') # Saving the tensors to plot histograms
    torch.save(su_ta_teinpy.cpu().detach(), 'su_ta_std_teinpy_kl'+str(int(100*beta))+'_hardtanh.pt') # Saving the tensors to plot histograms
    torch.save(su_ta_teouty.cpu().detach(), 'su_ta_std_teouty_kl'+str(int(100*beta))+'_hardtanh.pt') # Saving the tensors to plot histograms
    torch.save(su_ta_gaussy.cpu().detach(), 'su_ta_std_gaussy_kl'+str(int(100*beta))+'_hardtanh.pt') # Saving the tensors to plot histograms
    torch.save(su_ta_teinpi.cpu().detach(), 'su_ta_std_teinpi_kl'+str(int(100*beta))+'_hardtanh.pt') # Saving the tensors to plot histograms
    torch.save(su_ta_teouti.cpu().detach(), 'su_ta_std_teouti_kl'+str(int(100*beta))+'_hardtanh.pt') # Saving the tensors to plot histograms
    torch.save(su_ta_gaussi.cpu().detach(), 'su_ta_std_gaussi_kl'+str(int(100*beta))+'_hardtanh.pt') # Saving the tensors to plot histograms
    ...
    fig.savefig('sumnist_train_ta_std_kl'+str(int(100*beta))+'_hardtanh.jpg')
    ...
    cbar_ax = fig.add_axes([0.85, 0.115, 0.02, 0.76])
    fig.colorbar(img, cax=cbar_ax)
    fig.savefig('sumnist_test_ta_std_kl'+str(int(100*beta))+'_hardtanh.jpg')
    ...
    cbar_ax = fig.add_axes([0.85, 0.115, 0.02, 0.76])
    fig.colorbar(img, cax=cbar_ax)
    fig.savefig('sunet_train_ta_std_kl'+str(int(100*beta))+'_hardtanh.jpg')
    ...
    cbar_ax = fig.add_axes([0.85, 0.115, 0.02, 0.76])
    fig.colorbar(img, cax=cbar_ax)
    fig.savefig('sunet_test_ta_std_kl'+str(int(100*beta))+'_hardtanh.jpg')
    ...
    cbar_ax = fig.add_axes([0.85, 0.115, 0.02, 0.76])
    fig.colorbar(img, cax=cbar_ax)
    fig.savefig('sunet_gauss_ta_std_kl'+str(int(100*beta))+'_hardtanh.jpg')
